package com.bit101
{
	...
	public class Grid
	{
		...
		/**
		 * returns the node at the given coords as walkable or not.
		 * @param x The x coord.
		 * @param y The y coord.
		 */
		
		public function getWalkable(x:int, y:int, isoGridWidth:int, isoGridLength:int ):Boolean
		{		
			if ( x >= 0 && x < isoGridWidth && y >= 0 && y < isoGridLength ) {				
